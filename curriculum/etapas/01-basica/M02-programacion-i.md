...
- Empezar *Código limpio* (Robert C. Martin, ed. ES) — capítulos de nombres y funciones (lento).
...
3. **P3:** Vitest con ≥10 tests pasando en CI local (`npm test`).
...
Esto te sirve en la vida real para disciplina de estudio.
