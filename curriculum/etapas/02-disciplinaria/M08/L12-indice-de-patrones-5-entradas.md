...
horas: 5.0
semana: 3
lectura: "*Introducción a los algoritmos* — CLRS (ed. ES): Programación dinámica (intro) — indice-patrones.md"
...
Producir evidencia en `projects/m08-algoritmos/` alineada con: ≥5 patrones clasificados.
...
|--------|----------|--------|
| *Introducción a los algoritmos* — CLRS (ed. ES) | Semana 3: Programación dinámica (intro) — indice-patrones.md | [VisuAlgo](https://visualgo.net/en) |
