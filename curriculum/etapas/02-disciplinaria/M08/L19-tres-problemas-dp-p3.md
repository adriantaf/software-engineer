...
horas: 5.0
semana: 5
lectura: "*Introducción a los algoritmos* — CLRS (ed. ES): Greedy / selección de actividades — CLRS clásicos"
...
Producir evidencia en `projects/m08-algoritmos/` alineada con: dp/ tres carpetas con caso base.
...
|--------|----------|--------|
| *Introducción a los algoritmos* — CLRS (ed. ES) | Semana 5: Greedy / selección de actividades — CLRS clásicos | [VisuAlgo](https://visualgo.net/en) |
