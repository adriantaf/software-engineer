...
horas: 5.0
semana: 2
lectura: "*Fundamentos de BD* — Elmasri & Navathe (ed. ES): SQL consultas (SELECT/JOIN) — Elmasri 3FN"
evidencia: "er-agenda.md hasta 3FN"
---
...
Entregar `er-agenda.md hasta 3FN` con SQL ejecutado (no solo leído).
...
|--------|----------|--------|
| *Fundamentos de BD* — Elmasri & Navathe (ed. ES) | Semana 2: SQL consultas (SELECT/JOIN) — Elmasri 3FN | [Tutorial PostgreSQL](https://www.postgresql.org/docs/current/tutorial.html) |
