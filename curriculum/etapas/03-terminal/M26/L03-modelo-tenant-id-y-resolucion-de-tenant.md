...
Entregar evidencia de: Modelo tenant_id y resolución de tenant para el capstone Agenda Ops en producción.
...
git status
git commit -m "docs(m26): l03 modelo-tenant-id-y-resolucion-de-tenant"
```
...
1. Artefacto indicado existe: projects/m26-capstone/memoria/tenancy-modelo.md.
