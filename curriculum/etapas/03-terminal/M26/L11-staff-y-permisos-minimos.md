...
Entregar evidencia de: Staff y permisos mínimos para el capstone Agenda Ops en producción.
...
git status
git commit -m "docs(m26): l11 staff-y-permisos-minimos"
```
...
1. Artefacto indicado existe: projects/m26-capstone/memoria/roles.md.
