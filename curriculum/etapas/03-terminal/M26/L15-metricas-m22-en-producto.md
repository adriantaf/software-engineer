...
Entregar evidencia de: Métricas M22 en producto para el capstone Agenda Ops en producción.
...
git status
git commit -m "docs(m26): l15 metricas-m22-en-producto"
```
...
1. Artefacto indicado existe: projects/m26-capstone/metricas.md.
