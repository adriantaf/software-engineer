...
Entregar evidencia de: Tests regresión flujos críticos para el capstone Agenda Ops en producción.
...
Suite mínima en CI para citas + auth.
...
git status
git commit -m "docs(m26): l12 tests-regresion-flujos-criticos"
```
...
1. Artefacto indicado existe: pipeline.
