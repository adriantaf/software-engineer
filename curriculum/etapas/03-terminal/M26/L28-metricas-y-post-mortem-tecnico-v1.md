...
Entregar evidencia de: Métricas y post-mortem técnico v1 para el capstone Agenda Ops en producción.
...
git status
git commit -m "docs(m26): l28 metricas-y-post-mortem-tecnico-v1"
```
...
1. Artefacto indicado existe: projects/m26-capstone/post-mortem-v1.md.
